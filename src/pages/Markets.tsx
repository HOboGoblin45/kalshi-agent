    ...
    <div className="p-3 md:p-4 max-w-6xl mx-auto">
      <div className="flex items-center gap-2 mb-3">
        ...
        {agentState && (
          <div className="flex items-center gap-1.5">
            ...
            <span className={`text-[10px] font-semibold px-1.5 py-0.5 rounded-full ${agentState.enabled ? "text-accent-green bg-accent-green/15" : "text-accent-red bg-accent-red/15"}`}>
      ...
      <div className="relative mb-3">
        ...
        <input
          ...
          className="w-full h-9 pl-9 pr-4 rounded-xl bg-bg-surface border border-border-subtle text-sm text-text-primary placeholder:text-text-tertiary focus:outline-none focus:border-white/20"
        />
      </div>
        ...
        {filtered.map((m) => {
          ...
          return (
            ...
            >
              ...
              <h3 className="font-semibold text-[14px] text-text-primary mb-1.5 line-clamp-2">
                {m.title}
              </h3>

              <div className="flex items-center gap-2 text-[11px] text-text-secondary mb-2.5">
