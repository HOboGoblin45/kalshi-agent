  ...
  return (
    <div className="p-4 md:p-5 max-w-4xl mx-auto">
      <div className="flex flex-col items-center mb-6">
        <div className="w-16 h-16 rounded-full flex items-center justify-center text-xl font-bold mb-2" style={{ background: "var(--accent-color)" }}>
          KA
        </div>
              ...
              {accentColors.map((c) => (
                <button
                  ...
                  style={{
                    ...
                    transform: settings.accentColor === c.key ? "scale(1.12)" : "scale(1)",
                  }}
                >
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div>
      <h2 className="text-xs font-semibold text-text-secondary uppercase tracking-wider mb-2 px-1">{title}</h2>
